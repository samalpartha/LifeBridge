...
const MOCK_DICTIONARY: Record<string, string> = {
  ...
  "Invitation Letter for Family Visit.":
    "Carta de Invitación para Visita Familiar.",
  "Host: Alex Rivera. Address: 10 Maple St, Toronto, ON.":
    "Anfitrión: Alex Rivera. Dirección: 10 Maple St, Toronto, ON.",
  "Visitor: Sam Rivera. Travel window: January 15 - February 28, 2025.":
    "Visitante: Sam Rivera. Ventana de viaje: 15 de enero - 28 de febrero de 2025.",
  "Passport Number: P12345678, valid until December 2026.":
    "Número de Pasaporte: P12345678, válido hasta diciembre de 2026.",
  "Purpose: family visit during school holiday to spend time together.":
    "Propósito: visita familiar durante las vacaciones escolares para pasar tiempo juntos.",
  "Relationship: Parent and child.": "Relación: Padre e hijo.",
  "Accommodation: Guest room in host's residence.":
    "Alojamiento: Habitación de huéspedes en la residencia del anfitrión.",
  "Financial support: Host will cover all expenses during visit.":
    "Apoyo financiero: El anfitrión cubrirá todos los gastos durante la visita.",
};
