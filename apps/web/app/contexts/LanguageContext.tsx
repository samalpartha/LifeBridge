...
const dictionary = {
  en: {
    ...
    dashboard: {
      ...
      disclaimerText:
        "LifeBridge is an AI-powered document assistant, not a law firm. Determinations and checklists provided herein are for informational purposes only and do not constitute legal advice. Always consult with a qualified immigration attorney for your specific case.",
      dataCompliance:
        "Data stored locally on US servers. SOC2 Compliant (Pending).",
    },
    attorneys: {
  ...
  es: {
    ...
    heroSubtitle:
      "Sube tus documentos de movilidad transfronteriza. Obtén listas de verificación, cronogramas y evaluaciones de riesgo impulsadas por IA, todo con evidencia.",
    ...
    dashboard: {
      ...
      subtitle:
        "Rastrea tu progreso, gestiona evidencia y avanza en tu proceso migratorio.",
      ...
      createNewCase: "Crear Nuevo Caso",
      selectScenario:
        "Selecciona un escenario para obtener una lista personalizada.",
      ...
      dataCompliance:
        "Datos almacenados localmente en servidores de EE. UU. Cumplimiento SOC2 (Pendiente).",
    },
    attorneys: {
      title: "Buscar un Abogado",
      subtitle:
        "Usa IA para encontrar expertos en inmigración verificados cerca de ti.",
      location: "Ubicación",
      ...
      disclaimer:
        "Información obtenida de registros públicos y generación de IA. Siempre verifica las credenciales de forma independiente.",
    },
    embassy: {
    ...
    vault: {
      ...
      subtitle:
        "Almacena y gestiona de forma segura tus documentos de inmigración",
    ...
    tracker: {
      ...
      notes: {
        ...
        subtitle:
          "Realiza un seguimiento de pensamientos, reuniones y detalles importantes.",
        titleField: "Título",
        date: "Fecha",
        content: "Contenido",
        save: "Guardar Nota",
