...
import { Activity, ArrowRight, BookOpen, Clock3, ExternalLink, Gavel, RefreshCcw, ShieldCheck } from "lucide-react";
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-6">
                ...
                <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <p className="mt-2 max-w-3xl text-gray-600">
                            Actionable guides and legal navigation resources for real-world case decisions.
                            Built to move from confusion to confident next steps.
                        </p>
            ...
            <div className="surface-card animate-enter stagger-1 border border-blue-100 bg-blue-50/80 p-5 text-sm text-blue-900">
                <strong>Important:</strong> This content helps with orientation and planning. It does not replace licensed legal advice for your specific case.
            </div>

            {loading ? (
                <div className="surface-card animate-enter p-10">
                    <div className="mx-auto h-8 w-8 animate-spin rounded-full border-b-2 border-blue-600" />
                    <p className="mt-3 text-center text-sm text-slate-500">Loading live knowledge topics...</p>
                </div>
            ) : (
                <div className="space-y-6">
                            ...
                            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                <div className="max-w-3xl">
                                    <h2 className="mb-2 flex items-center gap-2 text-2xl font-bold">
                                        ...
                                        <ArrowRight size={24} className="opacity-0 -translate-x-2 transition group-hover:translate-x-0 group-hover:opacity-100" />
                                    </h2>
                                    <p className="text-blue-100">
                                        Search official legal contexts, Q&A, and topic-linked references in one place for faster preparation.
                                    </p>
                                </div>
                        ...
                        {topics.map((topic) => (
                            <Link key={topic.id} href={`/knowledge/${topic.id}`} className="group">
                                <article className="surface-card animate-enter stagger-2 flex h-full flex-col p-6">
                                    ...
                                    <p className="mb-4 flex-grow text-gray-600">{topic.description}</p>
                    ...
                    <div className="surface-card animate-enter stagger-3 p-6">
                        <h3 className="mb-2 text-lg font-semibold text-slate-900">Need case-specific help?</h3>
                        <p className="text-sm text-slate-600">
                            Use these guides for preparation, then validate your strategy with an attorney for legal certainty.
                        </p>
                        <div className="mt-4">
                            <Link href="/attorneys" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-white">
                                Find legal support
