  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        `/api/immigration-laws/search?q=${encodeURIComponent(query)}`,
      );
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3">
          ...
          <p className="text-sm text-blue-800">
            <strong>Disclaimer:</strong> This tool uses an AI-curated dataset of
            U.S. immigration laws. It is for informational purposes only and
            does not constitute legal advice. Always consult with a qualified
