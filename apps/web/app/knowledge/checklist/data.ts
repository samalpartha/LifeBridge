...
export const CHECKLIST_PATHS: Record<string, ChecklistPath> = {
  work: {
    ...
    label: "Work Visa",
    description:
      "For professionals seeking employment abroad (e.g., H1B, Blue Card).",
    sections: [
      {
        id: "prep",
        title: "1. Preparation",
        items: [
          {
            ...
            type: "upload",
            whyItMatters:
              "Most countries will deny entry if your passport expires soon.",
          ...
          },
          {
            ...
            description:
              "Obtain a formal job offer or contract from a sponsoring employer.",
            type: "upload",
            whyItMatters:
              "The primary requirement for work visas is a sponsoring entity.",
        ...
        items: [
          {
            ...
            description:
              "Your employer must often file a petition (e.g., I-129 for US) before you apply.",
            type: "task",
            whyItMatters:
              "This approval notice is the foundation of your personal application.",
          ...
          },
          {
            ...
            description:
              "Complete the online visa application form (e.g., DS-160).",
            type: "task",
            whyItMatters:
              "Initiates your personal background check and interview scheduling.",
  ...
  study: {
    ...
    label: "Student Visa",
    description:
      "For students accepted into university programs (e.g., F1, Tier 4).",
    sections: [
      {
        id: "acceptance",
        title: "1. Admission",
        items: [
          {
            ...
            description:
              "Get the official admission letter from your university.",
            type: "upload",
  ...
  nomad: {
    ...
    label: "Digital Nomad",
    description:
      "For remote workers wanting to live in another country temporarily.",
    sections: [
      {
        id: "income",
        ...
        items: [
          {
            ...
            description:
              "Prove you meet the monthly income requirement (varies by country).",
            type: "upload",
            whyItMatters:
              "Nomad visas are based on financial self-sufficiency.",
            timeEstimate: "1 week",
