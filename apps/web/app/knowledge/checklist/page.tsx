        ...
        <div className="max-w-4xl w-full">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500 max-w-2xl mx-auto">
              Select your path to generate a personalized immigration checklist
              with tasks and evidence tracking.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-xs text-gray-400">
              Content adapted from awesome-immigration by AwesomeVisa.
            </p>
          </div>
        </div>
      </div>
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-3 py-3 rounded-r-lg text-sm flex items-start gap-3 transition border-l-4 ${
                        isSelected
                    ...
                    >
                      <div
                        className={`mt-0.5 shrink-0 ${isCompleted ? "text-green-500" : "text-gray-300"}`}
                      >
                        {isCompleted ? (
                          <CheckCircle size={16} />
                        ) : (
                ...
                <div className="border-t border-gray-100 pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedItem.typicalDocuments.map((doc) => (
                      <span
                        key={doc}
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 text-xs font-medium border border-blue-100"
                      >
                        <FolderOpen size={12} />
                        {doc}
                      </span>
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
            ...
            <p className="text-yellow-800 text-xs leading-relaxed">
              This step often varies by consulate. Check specifically for{" "}
              <strong>{path.label}</strong> requirements in your destination
              country.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            ...
            <p className="text-gray-500 text-xs mb-4">
              Immigration rules change frequently. Connect with a verified
              attorney to review your documents.
            </p>
            <Link
              href="/attorneys"
              className="block w-full text-center bg-gray-50 text-blue-600 font-medium py-2 rounded-lg text-xs hover:bg-blue-50 transition border border-gray-200"
            >
              Find Attorney
            </Link>
          </div>
