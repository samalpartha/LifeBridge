    ...
    const guides: GuideItem[] = [
        {
            ...
            description: "Start with a clear sequence of steps so you always know what to do next.",
            color: "text-blue-500",
            bg: "bg-blue-50",
        ...
        },
        {
            ...
            description: "Store passports, visas, and supporting evidence safely in one place.",
        ...
        },
        {
            ...
            description: "Track deadlines and tasks so your filing timeline stays under control.",
        ...
        },
        {
            ...
            description: "Find trusted explanations and legal context before making decisions.",
        ...
        <div className="mx-auto max-w-7xl space-y-6">
            <section className="glass-panel shimmer-border animate-enter border-indigo-100 bg-gradient-to-br from-white via-indigo-50/35 to-cyan-50/25 p-6">
                ...
                <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <h1 className="text-4xl font-extrabold text-gray-900">Welcome to LifeBridge</h1>
                        <p className="mt-2 max-w-3xl text-lg text-gray-600">
                            Immigration processes can be complex. This page turns confusion into an action plan in minutes.
                        </p>
                        <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-semibold text-slate-700">
                            ...
                            Live workspace clock: <span suppressHydrationWarning>{new Date(now).toLocaleTimeString()}</span>
                        </div>
                    </div>
            ...
            <section className="surface-card animate-enter border border-indigo-100 bg-gradient-to-r from-indigo-50/70 via-white to-cyan-50/60 p-6">
                <div className="flex flex-wrap items-start justify-between gap-4">
                    <div className="max-w-3xl">
                        <h2 className="text-2xl font-bold text-gray-900">DigitalOcean Gradient Hackathon Focus</h2>
                        <p className="mt-2 text-sm text-gray-700">
                            LifeBridge is optimized as a hackathon-grade crisis workflow: live Gradient runtime, source-backed
                            guidance, and traceable operations from alert to reunification.
                        </p>
                        <ul className="mt-4 space-y-2 text-sm text-gray-700">
                            <li>• Verify live mode at <code>/crisis/runtime/live-check</code> in API docs.</li>
                            <li>• Use <code>/crisis</code> for end-to-end haven, route, beacon, and help operations.</li>
                            <li>• Review source-backed outputs and traces for judge-ready transparency.</li>
                        </ul>
                    </div>
                ...
                {guides.map((guide) => (
                    <Link key={guide.title} href={guide.link} className="group h-full">
                        <article className="surface-card animate-enter stagger-1 flex h-full items-start gap-4 border border-gray-200 p-6 hover:border-blue-200">
                            <div className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl ${guide.bg}`}>
            ...
            <section className="surface-card animate-enter stagger-2 p-6">
                <h2 className="mb-6 text-2xl font-bold text-gray-900">Who is LifeBridge for?</h2>
                <div className="grid gap-4 md:grid-cols-3">
                    <div className="rounded-xl bg-blue-50 p-5">
                        <span className="mb-3 block text-2xl">🎓</span>
                        <h3 className="font-bold text-gray-900">Students</h3>
                        <p className="mt-1 text-sm text-gray-600">
                            Navigate F-1 visa planning, OPT timing, and education transitions with less stress.
                        </p>
                    </div>
                    <div className="rounded-xl bg-purple-50 p-5">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Manage H-1B, O-1, and green-card milestones while balancing work and life commitments.
                        </p>
                    </div>
                    <div className="rounded-xl bg-green-50 p-5">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Keep cross-border documentation and timelines organized during travel and relocation.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="surface-card animate-enter stagger-3 p-6">
                ...
                <div className="grid gap-4 md:grid-cols-4">
                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        ...
                        <p className="mt-1 text-sm text-gray-600">Pick your path in Checklist and set priorities.</p>
                    </div>
                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        ...
                        <p className="mt-1 text-sm text-gray-600">Convert each step into actionable items in Tracker.</p>
                    </div>
                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        ...
                        <p className="mt-1 text-sm text-gray-600">Upload and organize proofs in Vault with labels.</p>
                    </div>
                    <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4">
                        <p className="text-xs font-semibold uppercase tracking-wide text-emerald-700">Step 4</p>
                        <p className="mt-1 font-semibold text-gray-900">Execute with confidence</p>
                        <p className="mt-1 text-sm text-gray-600">Track progress, exports, and legal readiness.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="surface-card animate-enter stagger-4 border border-slate-200 bg-slate-50 p-8 text-center">
                ...
                <p className="mx-auto mt-2 max-w-xl text-gray-600">
                    If your situation is urgent or legally complex, connect with an attorney and use the workspace to stay organized.
                </p>
