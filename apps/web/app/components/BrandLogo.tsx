...
export function BrandLogo({
    ...
    const subtitleClass = variant === "light" ? "text-slate-200" : "text-slate-600";
    ...
    return (
        ...
        >
            ...
            <div>
                <h1 className={`text-2xl font-bold leading-tight ${titleClass}`}>LifeBridge</h1>
                {showSubtitle && (
                    <p className={`text-sm leading-tight ${subtitleClass}`}>Crisis + Mobility Copilot</p>
                )}
            </div>
        </Link>
    );
