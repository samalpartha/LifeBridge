        ...
        events: [
          {
            ...
            description: "Met with attorney to discuss visa options.",
          },
          {
            date: "2023-02-01",
            title: "Documents Gathered",
            description:
              "Collected passport, birth certificate, and financial records.",
          },
          {
            date: "2023-03-10",
            title: "Application Submitted",
            description: "Form I-130 filed with USCIS.",
          },
          {
            date: "2023-06-22",
            title: "Receipt Notice",
            description: "Received I-797C Notice of Action.",
          },
        ],
      },
      null,
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="glass-panel shimmer-border animate-enter border-indigo-100 bg-gradient-to-br from-white via-indigo-50/40 to-sky-50/20 p-6">
        ...
        <p className="mt-2 max-w-3xl text-gray-600">
          Generate polished, downloadable case reports directly from your
          tracked timeline data.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-5 lg:col-span-1">
          ...
          <div className="surface-card border-blue-100 bg-blue-50/80 p-4 text-xs text-blue-700">
            ...
            This service uses WeasyPrint to render high-fidelity PDF case
            reports from structured JSON.
            <br />
            <br />
            <strong>Supported:</strong> CSS paged media, robust print styles,
        ...
        <div className="lg:col-span-2">
          <div className="surface-card h-full p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                onClick={() =>
                  setJsonData(JSON.stringify(JSON.parse(jsonData), null, 4))
                }
