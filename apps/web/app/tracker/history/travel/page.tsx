  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <div>
          <h3 className="text-blue-900 font-bold text-lg mb-1">
            Official I-94 Record
          </h3>
          <p className="text-blue-700 text-sm">
            Need your official travel history? Retrieve it directly from the CBP
            website.
          </p>
        </div>
        <a
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <h2 className="text-sm font-semibold text-gray-900 mb-6 uppercase tracking-wider border-b pb-2">
          Add New Trip
        </h2>
        <form
